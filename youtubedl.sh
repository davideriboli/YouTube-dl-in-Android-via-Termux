...
echo -e $Y $L "Getting config file..." $N
		wget https://raw.githubusercontent.com/davideriboli/YouTube-dl-in-Android-via-Termux/master/config -P /data/data/com.termux/files/home/.config/youtube-dl
...
echo -e $Y $L "Getting files..." $N
		wget https://raw.githubusercontent.com/davideriboli/YouTube-dl-in-Android-via-Termux/master/termux-url-opener -P /data/data/com.termux/files/home/bin
		clear
